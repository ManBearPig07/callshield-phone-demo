...
4. Tap **Live Demo**.
5. Try **Home inspection**, **HVAC**, **Safety**, **Wrong service**, **Out of area**, and **Vendor**.
6. Tap **Ledger** and **ROI**.
7. Tap **Copy text to Seth** or **Share this demo** on **Next** if he wants to forward the demo.
8. Review **Integrations**, **Setup**, and **Next**.
